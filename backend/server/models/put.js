...
module.exports = {
  updateSnome: (id, { owner_id, location_id, header, time_to_mountain, mountain_access, availability_start, availability_end, street_address, bedrooms, bathrooms, number_of_beds, perks, snome_description }) => {
    let result = db.none(`
    UPDATE snome
    SET
      owner_id=$1,
  ...
  updateUser: (id, { location_id, name, travel_start, travel_end, age, user_phone, user_photo, video_tour, about, email, mailing_address, residential_address }) => {
    let result = put.none(`
      UPDATE snome_user
      SET
        location_id=$1,
